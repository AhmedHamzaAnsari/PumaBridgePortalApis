...
if (isset($_POST)) {
    ...
    if($role=='Order' || $role=='Order (GM Team)' || $role=='Logistics'|| $role=='Reporting' || $role=='Monitoring' || $role=='Inspection Monitoring' || $role=='Eng'|| $role=='Planner' || $role=='tracker' || $role=='Cartraige'){
        $sales_role = $role;
    }
