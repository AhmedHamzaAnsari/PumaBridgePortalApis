...
$tommorrow = $next_date->format('Y-m-d');
	...
	// $sql__devi="SELECT pos.device_id as uniqueId,pos.vehicle_id as name FROM sitara.positions as pos where speed>'55' and pos.time>'$curr_date 00:00:00' and pos.time<'$curr_date 15:00:00'  and power='1' group by pos.vehicle_id;";
	$sql__devi="SELECT pos.device_id as uniqueId,pos.vehicle_id as name,us.users_id FROM sitara.users_devices as us inner join sitara.positions as pos on us.devices_id=pos.device_id where users_id=$user_id and speed>'55' and pos.time>'$curr_date 00:00:00' and pos.time<'$curr_date 15:00:00'  and power='1'  group by pos.vehicle_id;";
...
$next_date -> modify('-1 day');
$tommorrow = $next_date->format('Y-m-d');
	$sql__="SELECT pos.vehicle_id,pos.time,pos.speed,pos.vlocation,pos.latitude,pos.longitude FROM sitara.positions as pos where pos.device_id='$value' and  pos.time>'$curr_date 00:00:00' and pos.time<'$curr_date 15:00:00' and pos.power='1' order by pos.time asc;";
	...
	$sql__2="SELECT MAX(pos.speed) as maxx,MIN(pos.speed) as minn FROM sitara.positions as pos where pos.speed>'55' and pos.device_id='$value' and  pos.time>'$curr_date 00:00:00' and pos.time<'$curr_date 15:00:00' and pos.power='1' order by pos.time asc;";
...
$tommorrow = $next_date->format('Y-m-d');
	...
	$query = "SELECT pos.device_id,pos.vehicle_id,pos.speed,pos.vlocation,pos.time,pos.latitude,pos.longitude FROM sitara.positions as pos where speed>'55' and pos.time>'$curr_date 00:00:00' and pos.time<'$curr_date 15:00:00'  and power='1'";
