...
function smtp_mailer($to, $time, $vehi_name, $overspeed_count, $excess_driving, $black_spot_in, $nr_html, $time_1, $cartraige_id, $black_1, $cartraige_name, $report_timing, $night_voilation_t, $currentHour, $db)
{
    ...
    $mail->Body = '<h1>SITARA.<h1><h3>Please Find details report of Overspeed in attach PDF File.</h3><br/>' . $overspeed_count . '<br/>' . $excess_driving . '<br/>' . $black_spot_in . '<br/>' . $nr_html . '<br/>' . $night_voilation_t . '<br/>' . $alert_link; //An HTML or plain text message body
