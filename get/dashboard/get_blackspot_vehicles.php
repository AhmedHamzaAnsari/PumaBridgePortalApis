...
if ($pass != '') {
    ...
    if ($pass == $access_key) {
        ...
        $sql_query1 = "SELECT dc.id as device_id,dc.name as name,geo.consignee_name,geo.location,ck.in_time,ck.out_time,ck.in_duration,us.name as username FROM geo_check as ck
