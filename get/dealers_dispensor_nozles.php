...
if ($pass != '') {
    if ($pass == $access_key) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $get_orders = "SELECT dz.*,dp.name as product_name,ds.name as dispenser_name,dl.lorry_no as tank_name,
            ...
            join dealers_lorries as dl on dl.id=dz.tank_id where dz.dispenser_id='$id' and dz.dealer_id='$dealer_id';";
            // echo $get_orders .'<br>';
