...
if ($pass != '') {
    if ($pass == $access_key) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $get_orders = "SELECT sr.*,sq.question,rf.file as cancel_file FROM survey_response_eng as sr 
            join survey_category_questions_eng as sq on sq.id=sr.question_id
            LEFT JOIN survey_response_files_eng rf ON (rf.question_id = sr.question_id and rf.inspection_id=sr.inspection_id)
