...
$connection_selected = mysqli_select_db($connection, $database);
if (!$connection_selected) {
    die('Can\'t use connection : ' . mysqli_error($connection));
}
...
function trip_close()
{
    ...
    curl_setopt_array($curl, array(
        CURLOPT_URL => 'http://localhost:8080/OMCS-CMS-APIS/services/orders/geo_check/sap_trip_close.php',
...
function trip_eta()
{
    ...
    curl_setopt_array($curl, array(
        CURLOPT_URL => 'http://localhost:8080/OMCS-CMS-APIS/services/orders/sap_trip_eta.php?key=03201232927',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
