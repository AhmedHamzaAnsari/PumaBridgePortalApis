...
function get_net_price($id, $created_at, $sapNo)
{
   ...
   echo $url = 'http://151.106.17.246:8080/OMCS-CMS-APIS/services/sap_api_services/api_4/api_4_data_check.php?sap=' . $id . '&from=' . $newDate . '&to=' . $formattedDate . ''; // Replace '...' with the provided data string
