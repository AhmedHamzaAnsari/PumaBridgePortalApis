...
if ($pass != '') {
    if ($pass == $access_key) {
        ...
        $sql_query1 = "SELECT * FROM dealers where privilege='Dealer' and indent_price !='1' and sap_no!=''   order by id desc;";
        ...
        while ($user = $result1->fetch_assoc()) {
            ...
            $url = 'http://151.106.17.246:8080/OMCS-CMS-APIS/services/sap_api_services/api_1/api_1_data_check.php?sap=' . $sap . ''; // Replace '...' with the provided data string
