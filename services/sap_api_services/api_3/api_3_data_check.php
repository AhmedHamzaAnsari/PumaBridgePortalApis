...
if ($sap != "") {
    ...
    //     $curl,
    //     array(
    //         CURLOPT_URL => 'https://103.111.160.120:44302/sap/opu/odata/sap/ZP2P_TRACK_PROJ_SRV/InitialSet2(CustomerId=\'' . $sap . '\',FromDate=\'' . $fix_start_date . '\',ToDate=\'' . $currentDate . '\')',
    ...
    curl_setopt_array(
        $curl,
        array(
            CURLOPT_URL => 'https://103.111.160.120:44302/sap/opu/odata/sap/ZP2P_TRACK_PROJ_SRV/InitialSet8(CustomerId=\'' . $sap . '\')',
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
            ...
            CURLOPT_CUSTOMREQUEST => 'GET',
            CURLOPT_HTTPHEADER => array(
                'Authorization: Basic U0FQLkFQSTpBZG1pbkAxMjM=',
    'Cookie: SAP_SESSIONID_PRD_100=43lq5qFA5zMoxSLhCabIm4crof1byhHvsoEAUFa6A50%3d; sap-usercontext=sap-client=100'
            ),
        )
    );
